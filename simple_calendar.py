...
class SimpleCalendar:
    ...
    async def start_calendar(
        ...
        inline_kb.insert(InlineKeyboardButton(
            f'{calendar.month_name[month][:3]} {str(year)}',
        ...
        inline_kb.row()
        inline_kb.insert(InlineKeyboardButton(
            "<month", callback_data=calendar_callback.new("PREV-MONTH", year, month, day)
        ))
        inline_kb.insert(InlineKeyboardButton(" ", callback_data=ignore_callback))
        inline_kb.insert(InlineKeyboardButton(
            "month>", callback_data=calendar_callback.new("NEXT-MONTH", year, month, day)
        ))
